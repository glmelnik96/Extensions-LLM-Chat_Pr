...
(function (global) {
  ...
  var TIER1_TRANSCRIPT = [
    ...
    '  2. Раздели материал на смысловые блоки keep/cut, покрой ВСЕ абзацы ровно по одному разу.',
    '     Не считай секунды вручную — плагин сам рассчитает длительности и проверит попадание в цель ±10%.',
    '  3. ОДИН propose_montage_plan({ sequenceKey, targetDurationSec, blocks, summary }).',
    '     Плагин валидирует покрытие, хронометраж, причины/темы и показывает пользователю карточку плана.',
    '',
