    ...
    markers: [
      ...
      },
      {
        ...
        systemPromptAddon: [
          ...
          '1. get_timeline_snapshot → запомни sequenceEndSec.',
          '',
          '2. get_transcript_structure(sequenceKey: sequenceName).',
          '',
          '3. АДАПТИВНОЕ КОЛИЧЕСТВО ХАЙЛАЙТОВ ПО ДЛИНЕ:',
          ...
          '',
          '4. Найди МОМЕНТЫ ВЫСОКОГО НАПРЯЖЕНИЯ:',
          '   • Сильные тезисы и цифры',
          '   • Эмоциональные пики',
          '   • Цепляющие цитаты',
          '   • Неожиданные повороты / инсайты',
          '   ⚠ Если в материале нет ярких моментов (равномерный спокойный нарратив) —',
          '     поставь меньше хайлайтов чем рекомендуется, или предупреди пользователя.',
          '',
          '5. propose_markers({',
          '     markers: [',
          ...
          '     ],',
          '     summary: "N хайлайтов для шортсов"',
          '   })',
          '',
